...
<body class="auth-body">
    ...
    <div class="auth-formside">
        <div class="auth-form-wrap">
            ...
            @if (session('status'))
                <div class="alert alert-success">Se este e-mail estiver cadastrado, enviamos um link para redefinir a senha. Confira sua caixa de entrada — e também o spam.</div>
            @endif
